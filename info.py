...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002264005415').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-100'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-100'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003740983233'))  
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://jamessmithssp:jamessmithssp@cluster0.lemow.mongodb.net")
...
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/+0QnKVVq6v2s0NGNl')
